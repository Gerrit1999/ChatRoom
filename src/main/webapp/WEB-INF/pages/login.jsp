...
<head>
    ...
    <link rel="stylesheet" href="${pageScope.PATH}/layui/css/layui.css">
    <link rel="stylesheet" href="${pageScope.PATH}/layui/css/admin.css">
    <link rel="stylesheet" href="${pageScope.PATH}/layui/css/all.css">
</head>
<body>
        ...
        <div class="layadmin-user-login-main">
            ...
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="loginAcct" id="LAY-user-login-username" lay-verify="required"
                           placeholder="用户名" class="layui-input">
                </div>
                <div class="layui-form-item">
                    <label class="layadmin-user-login-icon layui-icon layui-icon-password"
                           for="LAY-user-login-password"></label>
                    <input type="text" name="userPswd" id="LAY-user-login-password"
